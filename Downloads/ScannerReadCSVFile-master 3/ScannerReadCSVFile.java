...
public class ScannerReadCSVFile {
    public void run() throws FileNotFoundException {
        ...
        while (scanner.hasNext()) {
            ...
            if (values.length >= 11) { //ensures that there is enough data in the values array to process
                ...
                int averageScore = totalScore / values.length; //calculates average of scores
