...
public class Constants //represent different states within the game, serve as identifiers for different states that the game can be in
{
    // Valid board size
    ...
    // Game states - predefined conditions or phases that the game can be in at any given time
    //the values assigned to each constant serve as unique identifiers for each state
    ...
    public static final int MAKE_MOVE = 5; //signifies that player has made a valid move and it's time to update the game board with that move
